...
- [**Users Table with Redux**](https://github.com/non4me21/table-redux) [**Live demo**](https://tableredux-mocha.vercel.app/): Users table with option to filter by column's fields. Data and filtering is based on [jsonplacehoder](https://jsonplaceholder.typicode.com/). Column filter must match exacly fields value. Technologies used: React, Redux Toolkit, Vercel.
